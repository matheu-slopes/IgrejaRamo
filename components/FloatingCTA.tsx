...
function WhatsAppIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.2" className={className}>
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50
                 ...
                 bg-transparent border-2 border-[#25D366] rounded-full
                 shadow-[0_4px_16px_0_rgba(0,0,0,0.08)]
                 hover:bg-[#25D366] hover:shadow-[0_4px_28px_0_rgba(37,211,102,0.3)]
                 hover:scale-110 active:scale-95
                 transition-all duration-300"
    >
      <WhatsAppIcon className="w-7 h-7 text-[#25D366] transition-colors duration-300 group-hover:text-white group-hover:fill-white" />
    </a>
  );
}
