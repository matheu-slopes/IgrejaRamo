    ...
    <section id="localizacao" className="py-24 px-6 bg-cream">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="font-sans text-4xl md:text-5xl font-semibold text-black">Localização</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-black text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-gray-900 transition"
            >
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-lg h-72 lg:h-96 bg-gray-50 flex items-center justify-center border-2 border-dashed border-gray-200">
