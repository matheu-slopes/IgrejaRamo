...
export default function QuemSomosSection() {
  return (
    <section id="quem-somos" className="py-24 px-6 bg-black">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-200 leading-relaxed text-[15px]">
              ...
              <p className="font-sans italic text-lg text-gray-300 leading-relaxed border-l-2 border-gold-600/40 pl-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={stat.label}
                className="bg-vine-900/60 border border-gray-900/60 rounded-2xl p-6 text-center hover:border-gold-700/40 transition"
              >
