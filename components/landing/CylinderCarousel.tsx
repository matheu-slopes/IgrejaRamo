...
const days: CultoDay[] = [
  {
    ...
    full: "Segunda-feira",
    title: "Oração",
    description: "Intercessão coletiva e fortalecimento espiritual.",
    time: "20h00",
  ...
  },
  {
    ...
    description: "Celebração com ação de graças, mensagem e comunhão.",
    time: "20h00",
    place: "Templo Principal",
  },
  {
    ...
    full: "Sábado",
    title: "Jovens",
    description: "Encontros quinzenais com comunhão, adoração e Palavra.",
    time: "19h30",
    place: "Sala 3",
  },
  {
